...
DATABASES = {
    'default': {
        ...
        'HOST': 'localhost',              # Hoặc tên Instance (VD: 'localhost\\SQLEXPRESS')
        'PORT': '',                       # Để trống nếu dùng Instance name, hoặc điền '1433'
        'OPTIONS': {
            'driver': 'ODBC Driver 17 for SQL Server', 
            # Bỏ comment dòng dưới nếu gặp lỗi về chứng chỉ (Certificate) ở local:
